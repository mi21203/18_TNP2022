...
\begin{frame}{Zašto tako malo žena ulazi u IT?}
    ...
    \begin{columns}
        ...
        \begin{figure}[h]
        \centering
        \includegraphics[width = .9\textwidth]{zene_u_ITsektoru.jpg}
        \label{fig:my_label}
        \end{figure}
    \end{columns}
...
{\usebackgroundtemplate{\includegraphics[width=\paperwidth, height=\paperheight]{pozadina.jpg}}
...
{\usebackgroundtemplate{\includegraphics[width=\paperwidth, height=\paperheight]{slika_za_kraj.jpg}}
\begin{frame}
    \centering
   \textbf{\Huge{KRAJ}} 
\end{frame}
